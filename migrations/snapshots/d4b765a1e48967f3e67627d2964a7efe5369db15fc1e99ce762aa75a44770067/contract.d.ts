...
export type StorageHash =
  StorageHashBase<'d4b765a1e48967f3e67627d2964a7efe5369db15fc1e99ce762aa75a44770067'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Personnel: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly id_utilisateur: CodecTypes['pg/int4@1']['output'] | null;
      readonly fonction: ReadonlyArray<
        | 'Gouverneur'
        | '1er Vice-Gouverneur'
        | '2e Vice-Gouverneur'
        | 'Auditeur Général'
      ...
      readonly public: {
        ...
        readonly enum: {
          ...
          readonly FonctionEnum: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'Gouverneur'; readonly value: 'Gouverneur' },
              { readonly name: 'Vice_Gouverneur_1'; readonly value: '1er Vice-Gouverneur' },
              { readonly name: 'Vice_Gouverneur_2'; readonly value: '2e Vice-Gouverneur' },
              { readonly name: 'Auditeur_General'; readonly value: 'Auditeur Général' },
              { readonly name: 'Conseillers'; readonly value: 'Conseillers' },
              { readonly name: 'Assistant_Gouv'; readonly value: 'Assistant Gouv.' },
              { readonly name: 'Cellule_COM'; readonly value: 'Cellule COM' },
              { readonly name: 'C_Deontologie'; readonly value: 'C. Déontologie' },
              { readonly name: 'C_Audit_Inform'; readonly value: 'C. Audit Inform.' },
              { readonly name: 'C_Conformite'; readonly value: 'C. Conformité' },
              { readonly name: 'DAI'; readonly value: 'DAI' },
              { readonly name: 'DSR'; readonly value: 'DSR' },
              { readonly name: 'DGSIF'; readonly value: 'DGSIF' },
              { readonly name: 'DSB'; readonly value: 'DSB' },
              { readonly name: 'DSA'; readonly value: 'DSA' },
              { readonly name: 'DSIFI'; readonly value: 'DSIFI' },
              { readonly name: 'DGES'; readonly value: 'DGES' },
              { readonly name: 'DER'; readonly value: 'DER' },
              { readonly name: 'DSBP'; readonly value: 'DSBP' },
              { readonly name: 'DDA'; readonly value: 'DDA' },
              { readonly name: 'DRI'; readonly value: 'DRI' },
              { readonly name: 'DGCC'; readonly value: 'DGCC' },
              { readonly name: 'D_Credit'; readonly value: 'D. Crédit' },
              { readonly name: 'DOC'; readonly value: 'DOC' },
              { readonly name: 'D_M_Prec'; readonly value: 'D. M. Préc.' },
              { readonly name: 'DCSMC'; readonly value: 'DCSMC' },
              { readonly name: 'DGASJ'; readonly value: 'DGASJ' },
              { readonly name: 'DAJ_D'; readonly value: 'DAJ/D' },
              { readonly name: 'DRH'; readonly value: 'DRH' },
              { readonly name: 'DPRC'; readonly value: 'DPRC' },
              { readonly name: 'DL'; readonly value: 'DL' },
              { readonly name: 'DMI'; readonly value: 'DMI' },
              { readonly name: 'DGE'; readonly value: 'DGE' },
              { readonly name: 'D_emission'; readonly value: 'D. émission' },
              { readonly name: 'D_Caisse_Centrale'; readonly value: 'D. Caisse Centrale' },
              { readonly name: 'DGR_Paiement'; readonly value: 'DGR Paiement' },
              { readonly name: 'D_Reseau'; readonly value: 'D. Réseau' },
              { readonly name: 'DGCP'; readonly value: 'DGCP' },
              { readonly name: 'DSPP'; readonly value: 'DSPP' },
              { readonly name: 'D_C_Interne'; readonly value: 'D. C. Interne' },
              { readonly name: 'DGFI'; readonly value: 'DGFI' },
              { readonly name: 'D_Comptabilite'; readonly value: 'D. Comptabilité' },
              { readonly name: 'D_Budget_Planif'; readonly value: 'D. Budget/Planif' },
              { readonly name: 'DSI'; readonly value: 'DSI' },
            ];
          };
          readonly StatutEnum: {
            readonly codecId: 'pg/text@1';
